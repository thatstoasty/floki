...
from floki.header import Headers, Header, HeaderKey, write_header
from floki.bytes import ByteReader, ByteWriter, is_newline, is_space


@fieldwise_init
struct RequestCookieJar(Copyable, ExplicitlyCopyable, Movable, Stringable, Writable):
