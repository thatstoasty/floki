...
Usage:
    pixi run -e util python utils/test_readme_examples.py
    python utils/test_readme_examples.py --readme README.md --mojo "pixi run -e util mojo"
...
def main() -> int:
    ...
    parser.add_argument(
        "--mojo",
        default="pixi run -e util mojo",
        help='Launcher for the mojo compiler (default: "pixi run -e util mojo").',
    )
    parser.add_argument(
        "--language",
        default="mojo",
